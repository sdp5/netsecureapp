...
<title>Network Tools [netsecureapp]</title>
<style type="text/css">
<!--
body,td,th {
...
<table width="800" align="center" bgcolor="#FFFFFF">
  <tr>
    <td width="968"><table width="800" border="0" align="center">
      ...
      <tr>
        <td width="29%" height="34"><div align="left"><a href="."><img src="../../images/nt.jpg" /></a></div></td>
...
<table width="755" border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#CCCCCC">
  <tr>
      ...
      <tr>
        <td colspan="2">
          <table width="100%" height="240px" align="center" cellpadding="5" cellspacing="5" style="vertical-align:top">
              <tr>
                <td><div align="right"><img src="images/dns.jpg" width="20" height="20" /></div></td>
                <td><div align="left"><a href="<?php $key=md5("dns"); echo "?key=".$key; ?>">DNS Query &amp; Look Up</a></div></td>
              </tr>
              <tr>
                <td><div align="right"><img src="images/port.jpg" alt="" /></div></td>
                <td><div align="left"><a href="<?php $key=md5("port"); echo "?key=".$key; ?>">Check Port</a></div></td>
              </tr>
              <tr>
                <td><div align="right"><img src="images/whois.jpg" width="20" height="20" /></div></td>
                <td><div align="left"><a href="<?php $key=md5("whois"); echo "?key=".$key; ?>">Whois Look Up </a></div></td>
              </tr>
              <tr>
                <td><div align="right"><img src="images/whoisip.jpg" width="20" height="20" /></div></td>
                <td><div align="left"><a href="<?php $key=md5("whoisip"); echo "?key=".$key; ?>">WhoisIP Look Up </a></div></td>
              </tr>
              <tr>
                <td><div align="right"><img src="images/ping.jpg" alt="" /></div></td>
                <td><div align="left"><a href="<?php $key=md5("ping"); echo "?key=".$key; ?>">Ping</a></div></td>
              </tr>
              <tr>
                <td><div align="right"><img src="images/tr.jpg" alt="" /></div></td>
                <td><div align="left"><a href="<?php $key=md5("trace"); echo "?key=".$key; ?>">Trace Route</a></div></td>
              </tr>
            </table>
          </td>
	...
	switch($_GET['key'])
	{
		case "$val1"	:	include("dns.php");
							break;		
		case "$val2"	:	include("port.php");
							break;
		case "$val3"	:	include("whois.php");
							break;
		case "$val4"	:	include("whoisip.php");
							break;
		case "$val5"	:	include("ping.php");
							break;
		case "$val6"	:	include("trace.php");
							break;
		default			:	echo "&nbsp;&nbsp;Welcome at <b>Network Tools [netsecureapp]</b><br /><br /><br /><br />&nbsp;&nbsp;Operating System Info...<br /><br />";
							$result = stristr($_SERVER['SERVER_SOFTWARE'], "win");
							if($result) echo "&nbsp;&nbsp;As the system is hosted on <b>Windows Server</b>,<br />&nbsp;&nbsp;Unix commands will not execute!!";
							else echo "&nbsp;&nbsp;As the system is hosted on <b>Linux Server</b>,<br />&nbsp;&nbsp;Unix commands will work!!";
							break;
	}
	?>
          </div></td>
